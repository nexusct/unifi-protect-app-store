# Nexus Vision commercial function ranking

**Status:** Final selection record. The commercial scores are prioritization estimates, not safety certification or technical acceptance tests.
